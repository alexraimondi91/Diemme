              ...
              <div class="form-group @error('principalImage') has-error @enderror">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    ...
                    <input required type="file" name="principalImage" class="custom-file-input" id="principalImage">
                  </div>
                </div>
              </div>
              <div class="form-group  @error('summernoteInput') has-error @enderror">
                <label for="inputDescription">Testo</label>
                <div class="card-body pad">
                  <div class="mb-3">
                    <p>Immagini per un totale di al max max 1MB</p>
                    <textarea required name="summernoteInput" class="textarea"
