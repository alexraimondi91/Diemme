...
<div class="slider_area">
    ...
    @else
    <div class="slider_active owl-carousel">
        <div style="background-image: url('img/news/custom.jpg')"
            class="single_slider overlay2 d-flex align-items-center justify-content-center slider_bg_1">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-5 offset-xl-1 col-md-6">
                <div class="about_info">
                    ...
                    <p>DIEMMEsport si occupa di vestire lo sportivo con tecnologie e prodotti di alta qualità senza
                        lasciare nulla al caso.
                        Ogni prodotto inoltre è totalmente personalizzabile grazie a Designer pronti ad occuparsi di
                        ogni dettaglio stilistico
